    ...
    <section id="about" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <div data-aos="fade-up" className="mb-16">
          <p className="text-[#a87070] text-sm tracking-widest uppercase font-body mb-2">Get to know me</p>
          <h2 className="font-heading font-black text-4xl md:text-5xl bg-gradient-to-r from-red-400 to-rose-500 bg-clip-text text-transparent">About Me</h2>
          <div className="w-12 h-0.5 bg-gradient-to-r from-red-400 to-rose-500 mt-4"></div>
        </div>

        <div className="grid md:grid-cols-2 gap-16">
          <div data-aos="fade-up" data-aos-delay="100">
            <h3 className="font-heading font-bold text-xl text-[#ef4444] mb-4">Background</h3>
            <p className="text-[#a87070] font-body leading-relaxed mb-6">
              I'm <span className="text-[#fef2f2]">Maulana Al-Ghiffari</span>, the third child of three siblings,
              born and raised in <span className="text-[#fef2f2]">Kota Semarang</span>. I have a deep interest
            ...
            <h3 className="font-heading font-bold text-xl text-[#ef4444] mb-4">Education</h3>
            <div className="space-y-4">
              <div className="border-l-2 border-[#3d1515] pl-4 hover:border-[#ef4444] transition-colors">
                <p className="text-[#fef2f2] font-body font-medium">SMK Negeri 7 Semarang</p>
                <p className="text-[#a87070] text-sm font-body">Sistem Informasi, Jaringan, dan Aplikasi</p>
                <p className="text-[#a87070] text-xs font-body mt-1">2024 – 2028</p>
              </div>
            </div>

            <div className="mt-8">
              <h3 className="font-heading font-bold text-xl text-[#ef4444] mb-3">Hobbies & Interests</h3>
            ...
            <div className="mt-6">
              <h3 className="font-heading font-bold text-xl text-[#ef4444] mb-2">Career Goal</h3>
              <p className="text-[#a87070] font-body text-sm leading-relaxed">
                Aiming to enter the <span className="text-[#fef2f2]">maritime / pelayaran</span> industry
          ...
          <div data-aos="fade-up" data-aos-delay="200">
            <h3 className="font-heading font-bold text-xl text-[#ef4444] mb-4">Soft Skills</h3>
            ...
            <h3 className="font-heading font-bold text-xl text-[#ef4444] mb-4">Hard Skills</h3>
